...
[!] If you use this, You must remove some features below Or You can modify it to your own.
 - Remove Meta tag **_"google-site-verification"_** in `/zola/templates/base.html`. It is from `Google Search Console`.
 - Remove Script **_"https://utteranc.es/client.js"_** in `/zola/templates/docs/page.html`. It is from [Utterances](https://utteranc.es).
## Features
...
4. GraphView moved to right side for avoiding to intercept mouse cursor's scroll.
